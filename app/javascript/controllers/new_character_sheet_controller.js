  ...
  checkSkillLevels(){
    for (let i = 0; i < this.skillTargets.length; i++){
      ...
      if (parseInt(this.skillTargets[i].value) < parseInt(this.statTargets[parentId].value) && parseInt(this.skillTargets[i].value) < 25){
        this.getSkillButtonById(skillId).disabled = parseInt(this.expTarget.value) <= 0;
        ...
        this.getSkillButtonById(skillId).disabled = parseInt(this.expTarget.value) < (parseInt(this.skillTargets[i].value) - parseInt(this.statTargets[parentId].value))+2;
      } else {
        this.getSkillButtonById(skillId).disabled = true
      }
    }
  }
